...
export default function AsideFilter() {
  return (
    <div className="py-4">
      <Link href={"/"} className="flex items-center font-bold text-orange">
      ...
      <ul>
        <li className="py-2 pl-2">
          <Link href={"/"} className="relative px-2 font-semibold text-orange">
            <svg
              viewBox="0 0 4 7"
      ...
      <Link href={"/"} className="mt-4 flex items-center font-bold uppercase">
        <svg
